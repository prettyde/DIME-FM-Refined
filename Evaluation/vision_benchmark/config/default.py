...
# add for proj_distill
_C.MODEL.DISTILL_TEXT = False
_C.MODEL.IMAGE_ENCODER = CN(new_allowed=True)
_C.MODEL.IMAGE_ENCODER.SPEC = CN(new_allowed=True)
_C.MODEL.IMAGE_ENCODER.SPEC.EMBED_DIM = 768

_C.MODEL.LANG_ENCODER = CN(new_allowed=True)
_C.MODEL.LANG_ENCODER.WIDTH = 768

_C.MODEL.UNICL_MODEL = CN(new_allowed=True)
_C.MODEL.UNICL_MODEL.DIM_PROJECTION = 768

_C.MODEL.STUDENT = CN(new_allowed=True)
_C.MODEL.STUDENT.TEXT = CN(new_allowed=True)
_C.MODEL.STUDENT.TEXT.NAME = 'ViT-L/14'

_C.MODEL.STUDENT.IMAGE = CN(new_allowed=True)
_C.MODEL.STUDENT.IMAGE.NAME = 'ViT-B/32'
